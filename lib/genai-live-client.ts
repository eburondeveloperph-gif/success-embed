...
// FIX: Refactored to use composition over inheritance for EventEmitter to resolve 'Property emit does not exist' errors.
export class GenAILiveClient {
  private emitter = new EventEmitter<LiveClientEventTypes>();

  // Expose on and off methods from the internal emitter
